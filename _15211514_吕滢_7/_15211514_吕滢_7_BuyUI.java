...
public class _15211514_吕滢_7_BuyUI extends JFrame {
    private _15211514_吕滢_7_Controller controller;
    private _15211514_吕滢_7_ShoppingCarUI shoppingCart;
    ...
    _15211514_吕滢_7_BuyUI(_15211514_吕滢_7_Controller controller) {
        this.controller = controller;
        this.shoppingCart = new _15211514_吕滢_7_ShoppingCarUI();
        ...
        buyButton.addActionListener(e -> {
            try {
                if ((int)numberField.getValue() == 0)
                    JOptionPane.showMessageDialog(null, "购买本数至少为一");
                else {
                ...
                JOptionPane.showMessageDialog(null, "请添加已有的图书");
            }
        });
