...
public class _15211514_吕滢_7_StrategiesUI extends JFrame {
    ...
    _15211514_吕滢_7_StrategiesUI(_15211514_吕滢_7_Controller controller) {
    ...
    private void InitAction() {
        ...
        updateButton.addActionListener(e -> {
            if (strategyChooseBox.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "请选择更新的策略");
            } else {
    ...
    private void InitUI() {
        ...
        for (Vector<Object> x : controller.getStrategies()) {//显示策略
        ...
        defaultComboBoxModel1.addElement("百分比折扣策略");
        defaultComboBoxModel1.addElement("绝对值优惠策略");
